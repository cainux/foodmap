...
- [x] 5.4 With the list open and scrolled to the end, the final card is fully visible and
      tappable
- [x] 5.5 Desktop at >768px is unchanged — the panel still slides in from the left with no
