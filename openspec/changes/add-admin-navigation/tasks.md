...
- [x] 6.3 Manually verify hamburger collapse below 900px and single-row layout at/above 900px
- [x] 6.4 Manually verify logout clears the session and redirects to login, and that a subsequent visit to `/` redirects back to login
- [x] 6.5 Manually verify adding a restaurant from `/restaurants/new` works, including duplicate warning
